...
class EconomyList extends Component {

  constructor(props) {
    super(props);
    this.state = {category: 'Economy'}
  }
  ...
  render() {
    const {isPending, data} = this.props.articles;
        ...
        <div >
...

          {
            !this.props.noMoreData ?
              ...
              :
              <div className="outofarticles"><h4>We ran out of articles, sorry!</h4></div>
          }
        </div>
    );
  }
